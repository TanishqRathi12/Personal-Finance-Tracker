...
export const AddTransaction = () => {
    ...
    return(
        <form onSubmit={handleSubmit} className="text-center" id="form" >
            <input name="input1" type="text" required value={description} onChange={(e)=> setDescription(e.target.value)} className="p-2 mr-2 border-rounded" placeholder="Description"/>
            ...
            <button type="submit" className="p-2 text-white bg-blue-500 m-2">Add Transaction</button>
        </form>
    );
}